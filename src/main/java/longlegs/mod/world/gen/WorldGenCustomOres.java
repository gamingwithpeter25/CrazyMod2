...
{
	private WorldGenerator ore_overworld_crazy;
	private WorldGenerator ore_overworld_copper;
	
	
	public WorldGenCustomOres() 
	{
		ore_overworld_crazy = new WorldGenMinable(BlockInit.ORE_OVERWORLD.getDefaultState().withProperty(BlockOres.VARIANT, EnumHandler.EnumType.CRAZY), 9, BlockMatcher.forBlock(Blocks.STONE));
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) 
	{
		...
		case -1:
			...
			runGenerator(ore_overworld_crazy, world, random, chunkX, chunkZ, 50, 0, 100);
