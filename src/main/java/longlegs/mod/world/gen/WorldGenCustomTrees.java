package longlegs.mod.world.gen;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.Random;

import longlegs.mod.world.biomes.BiomeCopper;
import longlegs.mod.world.biomes.BiomeCrazy;
import longlegs.mod.world.gen.generators.WorldGenCopperTree;
import longlegs.mod.world.gen.generators.WorldGenCrazyTree;
...
{
	private final WorldGenerator COPPER = new WorldGenCopperTree(true,false);
	private final WorldGenerator CRAZY = new WorldGenCrazyTree(true,false);
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) 
	{
		...
		case 0:
			...
			runGenerator(CRAZY, world, random, chunkX, chunkZ, 3, -1, 0, BiomeCrazy.class);
