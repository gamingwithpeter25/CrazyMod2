...
import longlegs.mod.objects.blocks.item.ItemBlockVariants;
import longlegs.mod.util.handlers.EnumHandler;
import longlegs.mod.util.interfaces.IHasModel;
import longlegs.mod.util.interfaces.IMetaName;
...
{	
	...
	public void generateTree(World world, Random rand, BlockPos pos, IBlockState state)
	{
		...
		{
		case COPPER:
			gen = new WorldGenCopperTree(true,false);
			break;
		case CRAZY:
			gen = new WorldGenCrazyTree(true,false);
			break;
		}
